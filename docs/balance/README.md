...
| **Pistes** | Après les playtests : Régénération parasitaire, Nouvel arrivage, la prime sur le leader en événement, une carte de réanimation, une carte de pacte ; combo laissé ouvert | **En discussion** avec le designer ([dossier](pistes-apres-playtests.md)). Aucun développement demandé |
