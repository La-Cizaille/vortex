...
| **Pistes** | Après les playtests (ARB-103 à ARB-108) : Régénération parasitaire, Nouvel arrivage à marchés élargis, événement « Avis de recherche » à mesurer ; cartes « Remorquage » et « Pacte de non-agression » à explorer ; combo laissé ouvert | Conçues : [dossier](pistes-apres-playtests.md). En attente du moteur (session principale) |
