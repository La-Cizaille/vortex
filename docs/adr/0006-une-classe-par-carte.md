...
- **Statut** : accepté, 2026-09-23. **Complété par [ADR-0007](0007-points-interception-et-briques-effets.md)** : les cas courants passent par des briques d'effets déclarées en données ; une classe reste la solution pour les effets exotiques.
...
2. **Classe par carte** qui redéfinit des points d'accroche typés. Les **valeurs** (+4, ×2, 15 PV…) restent dans les données.
