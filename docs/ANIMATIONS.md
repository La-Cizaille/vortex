...
| **Esquive** : le vaisseau glisse de côté, le rayon passe | Une attaque qui ne fait aucun dégât **sans que le bouclier y soit pour quelque chose** : effet qui annule les dégâts, ou attaque déviée (`AttackRedirected`) | **Moteur** : un événement qui dit qu'un dégât a été empêché et par quoi (bouclier, effet, déviation), pour choisir entre parade et esquive. **À trancher par le designer** : l'esquive couvre-t-elle aussi la déviation, ou la déviation a-t-elle sa propre animation (le rayon qui bifurque) ? | Aucun modèle ; traînée des réacteurs pendant l'écart | 2 |
...
| **Déviation** : le rayon bifurque vers la nouvelle cible | `AttackRedirected` | Voir la question sur l'esquive | 2 |
...
- **Lot 2** : parade et esquive (après l'ajout au moteur et la réponse du designer), Tourment, fond et ses effets, paquets du marché, critique, surcharge, sabotage, trajets des cartes, dégâts renvoyés, déviation, fin des temps, vaisseau endommagé.
