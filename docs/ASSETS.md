...
| **Icônes des actions d'équipage** | 5 : Attaque, Sabotage, Reparamétrage, Surcharge, Posture défensive | Le demi-cercle d'actions au-dessus du vaisseau (INTERFACE §3.4) | PNG transparent 256×256, silhouette lisible à 48 px | `Art/Icons/Action_Attaque.png`, `Action_Sabotage`, `Action_Reparametrage`, `Action_Surcharge`, `Action_Posture` | 2 |
