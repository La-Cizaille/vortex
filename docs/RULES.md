...
- **Combo (A8)** : défausser la paire pour obtenir la technologie rend le jeu peu fluide, n'incite pas à changer de cartes et contredit les bonus des cartes (remarque du designer après les playtests). Trois options ont été écartées (ARB-108) : pacte automatique, activation sans défausse, synergie continue. À rediscuter.
...
- **Pistes après les playtests** (ARB-103 à ARB-107) : à mesurer (Régénération parasitaire, Nouvel arrivage, événement « Avis de recherche ») ou à explorer (cartes « Remorquage » et « Pacte de non-agression »). Détail : [`balance/pistes-apres-playtests.md`](balance/pistes-apres-playtests.md).
