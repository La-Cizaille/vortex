...
- **Combo (A8)** : défausser la paire pour obtenir la technologie rend le jeu peu fluide, n'incite pas à changer de cartes et contredit les bonus des cartes (remarque du designer après les playtests). Trois options ont été proposées sans convenir au designer : pacte automatique, activation sans défausse, synergie continue. À rediscuter.
...
- **Pistes après les playtests**, en discussion, sans développement demandé : Régénération parasitaire (D_018), Nouvel arrivage, la prime sur le leader en événement, une carte de réanimation, une carte de pacte. Détail : [`balance/pistes-apres-playtests.md`](balance/pistes-apres-playtests.md).
