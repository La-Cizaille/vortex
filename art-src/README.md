...
|---|---|---|
| `ships/` | Un fichier `.blend` par vaisseau, nommé comme son export (`Ship_Faucon.blend`) | `unity/Assets/_Vortex/Art/Ships/Ship_Faucon.fbx` |
...
- **Export** d'un modèle : `blender --background art-src/ships/Ship_Faucon.blend --python tools/blender/export_unity.py -- unity/Assets/_Vortex/Art/Ships/Ship_Faucon.fbx`. Le script vérifie l'échelle et le budget de triangles avant d'exporter.
