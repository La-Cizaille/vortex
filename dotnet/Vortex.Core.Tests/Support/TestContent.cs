...
namespace Vortex.Core.Tests.Support
{
    ...
    internal static class TestContent
    {
        ...
        public static GameConfig Config(
            int eventFrequency = 1,
            int doomRound = 50,
            int startShield = 4,
            int startingHp = 30,
            RoundStartRotation rotation = RoundStartRotation.None,
            int technologiesToWin = 4,
            ...
            bool ghostsChooseEvent = false)
        {
            ...
            return new GameConfig(null, ContentFile.CurrentSchemaVersion, startingHp, 30, 0, 8, 8, 5, 1, 1, 1, eventFrequency, DoomEvent, rotation, technologiesToWin, counts, 16, 64, defensivePostureBonus, leaderBounty, ghostsChooseEvent);
        }
    }
