...
- Blender MCP (dev only): `.mcp.json`, pinned `mcp-for-blender==2.0.4`, safe mode and telemetry off; the addon listens on 127.0.0.1:9876. Model export: `blender --background --disable-autoexec <art-src/...blend> --python tools/blender/export_unity.py -- <unity/Assets/_Vortex/Art/...fbx> [--budget N]`; parametric models are built by script (`tools/blender/build_card.py`, ADR-0016). Blender 5.2 LTS (ARB-78).
